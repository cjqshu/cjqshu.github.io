...
- [python](https://www.python.org/) \| [中文官网](https://python.p2hp.com/) \| [中文文档](https://docs.python.org/zh-cn/) \| [Cheatsheet](https://www.pythoncheatsheet.org/) ![GitHub Repo stars](https://img.shields.io/github/stars/python/cpython)
